---
description: >-
  Use this agent when backend development tasks involving FastAPI, Python, SQLAlchemy, and PostgreSQL need to be executed. This includes creating data models, implementing REST API endpoints, developing business logic services, creating database migrations, and writing tests. For example, when a user says 'Create a new endpoint for user registration', 'Generate an Alembic migration for the new payments table', or 'Write unit tests for the authentication service', use this agent to leverage the backend skill to produce robust, tested, and well-structured backend code.
mode: subagent
permission:
  edit: allow
---
